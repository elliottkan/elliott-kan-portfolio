...
const Jobs = () => {
  ...
  const ConvertDigital = () => (
    <>
      <p>I'm a developer at Convert Digital, specializing in Shopify development. My role enables me to work with some really cool clients, each with their unique needs and specifications.</p>
      <p>As part of the Shopify team, I handle multiple features and projects concurrently, utilizing a range of technologies such as <strong>React, Cypress, Tailwind, Ruby, PHP, and Node.js</strong>. I'm well-versed in working with <strong>APIs</strong>, including both <strong>RESTful and GraphQL</strong>, and have contributed to our testing suite using <strong>Cypress</strong>.</p>
      <p>Some of my most significant contributions include leading a Searchspring integration, spearheading a loyalty feature using Omneo, and building complex swatches for several clients. I also played a crucial role in developing reusable functions for our Cypress testing suite, enabling the wider team to conduct efficient testing. Additionally, I've worked on aligning our development with WCAG2.2 guidelines, ensuring accessibility standards are met. Alongside these tasks, I regularly contribute to internal documentation, documenting processes, best practices, and project specifics to further enable the team.</p>
