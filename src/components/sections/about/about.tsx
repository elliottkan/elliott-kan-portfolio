  ...
  return (
    <div className="about-container">
      <div className="text-container">
        ...
        <p>I'm a driven and dedicated individual who is always looking for ways to improve myself and those around me. I have a passion for creating solutions that not only contribute to a more positive and sustainable future, but also bring joy and functionality to the users. Whether I'm tackling a difficult project or scaling a rock face, I approach everything with determination and a positive attitude.</p>
